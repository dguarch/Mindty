		...
		<form id="formCurso">
			...
			<div class="form-row">
				<div class="form-group col-12">
					<select id="profes" class="form-control col-12"
						...
						<option value="Angel M. Rayo">脕ngel M. Rayo</option>
						<option value="Joan Marimon">Joan Marim贸n</option>
						<option value="Xavier Saladie">Xavier Saladi茅</option>
						<option value="Eduardo di Monte">Eduardo di Monte</option>
						<option value="Luis Sanchez">Luis S谩nchez</option>
			...
			<div class="form-row">
				<div class="form-group col-5">
					<label for="modulos">N潞 m贸dulos</label> <input type="number"
						class="form-control" id="modulos" placeholder="1" min="1" max="10">
				</div>
				<div class="col-5">
					<label for="horas">N潞 horas</label> <input type="number"
